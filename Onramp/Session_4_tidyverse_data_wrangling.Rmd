...
ncha_df <- rename(ncha_df, 
                  ...
                  "exercise_mod_min" = "Exercise_mod_min",
                  "exercise_vig_min" = "Exercise_vig_min")
...
ncha_df_sub <- ncha_df %>% select(Overall.Health,Minutes.Moderate.PA...minutes,Minutes.Vigorous.PA...minutes)
...
ncha_df_sub <- filter(ncha_df_sub, Overall.Health == "Excellent")
...
ncha_df_sub <- ncha_df_sub %>% mutate(vig_activity_hour = Minutes.Vigorous.PA...minutes / 60)
ncha_df_sub <- ncha_df_sub %>% mutate(mod_activity_hour = Minutes.Moderate.PA...minutes/60)
```
...
ggplot(ncha_df_sub, aes(x = Overall.Health, y = mod_activity_hour)) + geom_boxplot()
