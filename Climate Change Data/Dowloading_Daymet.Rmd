...
df_batch <- download_daymet_batch(file_location = "~/PINC 2025/Bilaoen-PSP-2025/Climate Change Data/sf_centroids.csv", 
start = 2000, 
end = 2024, 
simplify = TRUE)
...
sf_daymet <- read_csv("~/PINC 2025/Bilaoen-PSP-2025/Climate Change Data/sf_daymet.csv")
...
write.csv(sf_daymet, "sf_daymet_clean.csv", row.names = FALSE)
```
