...
sf_neighborhoods <- read_csv("Data/Analysis_Neighborhoods_-_2020_census_tracts_assigned_to_neighborhoods_20250717.csv")
...
ggplot(neighborhood_heat_change_sf) +
  geom_sf(aes(fill = hw_2day_85_diff), color = "white", size = 0.2) +
  scale_fill_viridis_c(option = "plasma", na.value = "grey90") +
  labs(
    title = "Change in Heatwave Events by Census Tract",
    fill = "Average Annual Heatwaves 2day 85th"  ) +
  theme_void() +
  theme(
...
tm_shape(neighborhood_heat_change_sf) +
  tm_fill("hw_2day_85_diff",
          palette = "-RdYlBu",
          title = "Change in 2-Day 85th perecentile  (2000–2020)",
          midpoint = 0,
          colorNA = "lightgray") +
  tm_borders() +
  tm_layout(
