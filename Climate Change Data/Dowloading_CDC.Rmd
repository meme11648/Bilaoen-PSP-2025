...
# if you want to facet wrap facet_wrap(~ definition, ncol = 2) +
  labs(
    ...
    caption = "Figure 2: Spatial distribution of heatwave exposure events (2-day 97.5th percentile) and social vulnerability across San Francisco districts.\n Darker colors indicate areas with higher social vulnerability and greater increases in heat exposure" ) +
  theme_void() +
  theme(
